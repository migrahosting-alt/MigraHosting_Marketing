    ...
    try {
      ...
      const res = await fetch(`${API_BASE}/api/checkout`, {
        ...
        body: JSON.stringify({
          ...
          mode: "subscription", // Changed back to subscription since hosting uses recurring prices
          success_url: `${window.location.origin}/checkout/success`,
          cancel_url: `${window.location.origin}/pricing`,
          locale: selectedLocale,
          trial_period_days: hasTrial ? 14 : undefined,  // 14-day trial for Starter plan

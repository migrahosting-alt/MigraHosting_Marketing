        ...
        <div className="mt-10 space-y-8 text-white/80">
          <section>
            ...
            <ul className="mt-3 list-inside list-disc space-y-1 pl-4">
              <li>
                The <Link to="/terms#refund-policy" className="text-[#8A4DFF] hover:underline">Refund Policy</Link>
              </li>
              <li>
                The <Link to="/sla" className="text-[#8A4DFF] hover:underline">Uptime Service Level Agreement (SLA)</Link>
              </li>
          ...
          <section id="refund-policy">
            ...
            <p className="mt-3">
              We offer a 30-day money-back guarantee on standard hosting plans. If you cancel within the first 30 days of service, we will refund your initial payment minus any domain registration fees or usage-based add-ons that have already been provisioned.
            </p>
            <p className="mt-3">
              Refunds requested after the initial 30-day window are handled on a case-by-case basis and may be issued as account credits at our discretion. Setup fees, migration work, and third-party licenses are non-refundable.
            </p>
            <p className="mt-3 text-white/70">
              To request a refund, open a billing ticket in the client portal so our accounting team can verify eligibility and process the credit card reversal or account credit.
            </p>
          </section>

...
class MPanelClient {
  constructor(baseURL = 'http://localhost:2271') {
...
<body class="bg-gray-50">
  ...
  <script>
    const MPANEL_URL = 'http://localhost:2271'; // Change to your mPanel URL
...
export function useMPanel(baseURL = 'http://localhost:2271') {
...
function mpanel_get_plans() {
    $mpanel_url = 'http://localhost:2271'; // Change this
...
### Step 1: Update mPanel URL
Replace `http://localhost:2271` with your actual mPanel domain:
- **Production**: `https://panel.yourdomain.com`
- **Staging**: `https://staging-panel.yourdomain.com`
...
```bash
# Test plans endpoint
curl https://your-mpanel-domain.com/api/public/plans
...
```env
NEXT_PUBLIC_MPANEL_URL=https://panel.yourdomain.com
# or for Vite/Vue
VITE_MPANEL_URL=https://panel.yourdomain.com
```
